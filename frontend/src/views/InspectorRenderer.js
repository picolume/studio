...
export class InspectorRenderer {
    ...
    _renderProjectSettings(container, project) {
        ...
        const asLabel = document.createElement('label'); asLabel.innerText = "Enable Auto-Save"; asLabel.className = "text-xs text-gray-300";
    ...
    _addTextInput(parent, lbl, val, cb) {
        ...
        d.innerHTML = `<label class="block text-xs text-gray-400 mb-1">${lbl}</label>`;
        const inp = document.createElement('input');
        inp.className = "w-full bg-neutral-900 text-sm text-gray-300 border border-gray-700 rounded px-1 py-1 outline-none mb-3";
        inp.value = val;
